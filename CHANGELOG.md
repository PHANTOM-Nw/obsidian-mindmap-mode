...
- 更新到这个版本之后，Obsidian 第一次加载插件时会弹出一条一次性提示，说明这个版本修好了什么，之后不再出现。<br>The first load after this update shows a one-time notice naming the fixes it brings, and never shows it again.
